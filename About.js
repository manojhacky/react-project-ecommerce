...
import './about.css'
import './contact.css'
import dpacc from '/home/manoj/react1/frontend/src/dp.webp'
...
return (
    <div>
        <div className='acc1'>
            ...
            <img src={dpacc} className="dpa1"/>
            <h2 className='dp1'><span>Welcome   </span>Manoj Kumar </h2>
            
        </div><hr />
        <p className='dp11'>purchase what ever you need</p>
